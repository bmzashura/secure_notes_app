...
class _NoteEditorPageState extends State<NoteEditorPage> {
  ...
  void initState() {
    super.initState();
    if (_isEditing) {
      // Will be decrypted after PIN entry
    }
  }
  ...
  void _onSave() {
    ...
    // Show PIN dialog for encryption
    _showPinDialog();
  }
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              'Masukkan PIN untuk mengenkripsi catatan ini:',
